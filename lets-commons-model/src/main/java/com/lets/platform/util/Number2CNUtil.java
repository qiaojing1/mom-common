...
/**
 * @author zhangweiyan
 * @ClassName Number2CNUtil
 * @Description 数字转换为人民币大写
 * @Date 2024/11/18 17:21
 **/
public class Number2CNUtil {
    ...
    public static String numberToCn(BigDecimal numberOfMoney) {
        if (Objects.isNull(numberOfMoney)) {
            return "";
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("193847032471.23 ==》 " + Number2CNUtil.numberToCn(new BigDecimal(193847032471.23)));
    }
