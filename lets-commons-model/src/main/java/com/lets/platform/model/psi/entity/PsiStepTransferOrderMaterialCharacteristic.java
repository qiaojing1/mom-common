...
@Getter
@Setter
@TableName("psi_step_transfer_order_material_characteristic")
@ApiModel(value = "PsiStepTransferOrderMaterialCharacteristic对象", description = "分步调拨单物料明细特征属性")
public class PsiStepTransferOrderMaterialCharacteristic extends BaseEntity {
