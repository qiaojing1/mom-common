...
@Getter
@Setter
@TableName("mes_produce_material_bill_change_order_detail")
@ApiModel(value = "MesProduceMaterialBillChangeOrderDetail对象", description = "生产用料清单变更-明细")
public class MesProduceMaterialBillChangeOrderDetail extends BaseEntity {
    ...
    @TableField("before_demand_number")
    ...
    @TableField("before_can_use_number")
    ...
    @TableField("before_numerator_dosage")
    ...
    @TableField("before_denominator_dosage")
    ...
    @TableField("before_change_loss_rate")
    ...
    @TableField("before_stock_in_store_id")
    private String beforeStockInStoreId;
    @ApiModelProperty("调入仓库名称(变更前)")
    @TableField("before_stock_in_store_name")
    ...
    @TableField("before_stock_in_area_id")
    private String beforeStockInAreaId;
    @ApiModelProperty("调入库区名称(变更前)")
    @TableField("before_stock_in_area_name")
    ...
    @TableField("before_stock_in_position_id")
    private String beforeStockInPositionId;
    @ApiModelProperty("调入库位名称(变更前)")
    @TableField("before_stock_in_position_name")
    ...
    @ApiModelProperty("用料清单主键")
    @TableField("bill_order_id")
    private String billOrderId;
    @ApiModelProperty("用料清单明细主键")
    ...
    public BigDecimal fixedLossChange() {
        return Objects.isNull(fixedLoss) ? beforeFixedLoss : fixedLoss;
    }
    public BigDecimal changeLossRateChange() {
        return Objects.isNull(changeLossRate) ? beforeChangeLossRate : changeLossRate;
    }
    public BigDecimal numeratorDosageChange() {
        return Objects.isNull(numeratorDosage) ? beforeNumeratorDosage : numeratorDosage;
    }
    public BigDecimal denominatorDosageChange() {
        return Objects.isNull(denominatorDosage) ? beforeDenominatorDosage : denominatorDosage;
    }
}
