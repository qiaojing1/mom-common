...
@Getter
@Setter
@TableName("psi_step_transfer_in_order_material")
@ApiModel(value = "PsiStepTransferInOrderMaterial对象", description = "分步调拨单入库单物料明细")
public class PsiStepTransferInOrderMaterial extends BaseEntity {
    ...
    private BigDecimal transferReferenceQuantity;
    ...
    @TableField(exist = false)
    private List<PsiStepTransferInOrderMaterialCharacteristic> materialCharacteristics;
}
