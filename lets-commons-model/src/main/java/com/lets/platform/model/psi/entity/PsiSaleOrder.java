...
@Getter
@Setter
@TableName("psi_sale_order")
@ApiModel(value = "PsiSaleOrder对象", description = "销售订单")
public class PsiSaleOrder extends BaseEntity {
    ...
    @TableField("main_need_date")
    private LocalDateTime mainNeedDate;

    @ApiModelProperty("报价时间")
    @TableField("quotation_day")
    private LocalDateTime quotationDay;

    @ApiModelProperty("订货客户ID")
    @TableField("order_customer_id")
    @NotBlank(message = "[订货客户]不能为空")
    ...
    @ApiModelProperty("销售员系统账号")
    @TableField(exist = false)
    private String saleUserLoginId;
    @ApiModelProperty("销售员员工编号")
    @TableField(exist = false)
    private String saleUserEmployeeNumber;
    ...
    @TableField(exist = false)
    private List<PsiSaleOrderDelivery> deliveryList;

    @ApiModelProperty("订单要求")
    @TableField(exist = false)
    private List<PsiSaleOrderRequirement> requirementList;
    ...
    @ApiModelProperty("单据类别业务类型")
    @TableField(exist = false)
    private String businessCode;
    @ApiModelProperty("物料申请id")
    @TableField(exist = false)
    private String materialApplyId;
    @ApiModelProperty("是否可以修改 已审核的也可以修改")
    @TableField(exist = false)
