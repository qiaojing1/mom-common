...
@Getter
@Setter
@TableName("psi_inventory_stock_in_order")
@ApiModel(value = "PsiInventoryStockInOrder对象", description = "盘盈入库单")
public class PsiInventoryStockInOrder extends BaseEntity {
    ...
    @TableField(exist = false)
    private List<PsiInventoryStockInOrderDetail> details;
