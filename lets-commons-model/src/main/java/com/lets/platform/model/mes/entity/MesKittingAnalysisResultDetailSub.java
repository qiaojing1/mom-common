...
@Getter
@Setter
@TableName("mes_kitting_analysis_result_detail_sub")
@ApiModel(value = "MesKittingAnalysisResultDetailSub对象", description = "齐套分析方案仓库范围")
public class MesKittingAnalysisResultDetailSub extends BaseEntity {
    ...
    @TableField(exist = false)
    private List<MesKittingAnalysisResultDetailSubRecord> recordList;
    ...
    public void setTotalKittingQuantity(BigDecimal totalKittingQuantity) {
        if (totalKittingQuantity.compareTo(BigDecimal.ZERO) < 0) {
            this.totalKittingQuantity = BigDecimal.ZERO;
        } else {
            this.totalKittingQuantity = totalKittingQuantity;
        }
    }

    public void setKittingQuantity(BigDecimal kittingQuantity) {
        if (kittingQuantity.compareTo(BigDecimal.ZERO) < 0) {
            this.kittingQuantity = BigDecimal.ZERO;
        } else {
            this.kittingQuantity = kittingQuantity;
        }
    }
