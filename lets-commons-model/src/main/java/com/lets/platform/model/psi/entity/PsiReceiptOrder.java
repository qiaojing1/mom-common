...
@Getter
@Setter
@TableName("psi_receipt_order")
@ApiModel(value = "PsiReceiptOrder对象", description = "收款单")
public class PsiReceiptOrder extends BaseEntity {
    ...
    @ApiModelProperty("币种与本位币之间的汇率")
    @TableField("exchange_rate")
    private BigDecimal exchangeRate;

    @TableField(exist = false)
    private List<PsiReceiptOrderDetail> details;
    @TableField(exist = false)
