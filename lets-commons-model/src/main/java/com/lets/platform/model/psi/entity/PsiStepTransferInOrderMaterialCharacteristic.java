...
@Getter
@Setter
@TableName("psi_step_transfer_in_order_material_characteristic")
@ApiModel(value = "PsiStepTransferInOrderMaterialCharacteristic对象", description = "分步调拨入库单物料明细特征属性")
public class PsiStepTransferInOrderMaterialCharacteristic extends BaseEntity {
