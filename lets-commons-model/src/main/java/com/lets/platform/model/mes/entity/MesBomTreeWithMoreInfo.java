...
/**
 * MesBomTreeWithMoreInfo
 * @author DING WEI
 * @since 2023-11-07
 */
@Getter
@Setter
@ApiModel(value = "MesBomTreeWithMoreInfo对象", description = "BOM管理")
public class MesBomTreeWithMoreInfo {
    ...
    private List<MesBomTreeWithMoreInfo> children;
