...
/**
 * 生产工单-工艺路线-明细-工艺文件-副本
 * @author DING WEI
 * @since 2023-12-05
 */
@Getter
@Setter
@TableName("mes_produce_order_route_file")
@ApiModel(value = "MesProduceOrderRouteFile对象", description = "生产工单-工艺路线-明细-工艺文件-副本")
public class MesProduceOrderRouteFile extends BaseEntity {
