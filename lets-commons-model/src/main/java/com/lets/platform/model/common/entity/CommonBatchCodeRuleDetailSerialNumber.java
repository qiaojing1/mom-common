...
@Getter
@Setter
@TableName("common_batch_code_rule_detail_serial_number")
@ApiModel(value = "CommonBatchCodeRuleDetailSerialNumber对象", description = "批号自动编码流水号重置关联表")
public class CommonBatchCodeRuleDetailSerialNumber extends BaseEntity {
