...
/**
 * 计划订单-工艺路线-明细-工序信息-工艺文件-副本
 * @author DING WEI
 * @since 2023-12-18
 */
@Getter
@Setter
@TableName("psi_produce_plan_route_process_file")
@ApiModel(value = "PsiProducePlanRouteProcessFile对象", description = "计划订单-工艺路线-明细-工序信息-工艺文件-副本")
public class PsiProducePlanRouteProcessFile extends BaseEntity {
