...
@Getter
@Setter
@TableName("psi_step_transfer_order")
@ApiModel(value = "PsiStepTransferOrder对象", description = "分步调拨单表头")
public class PsiStepTransferOrder extends BaseEntity {
    ...
    @TableField(exist = false)
    private List<PsiStepTransferOrderMaterial> details;

    @TableField(exist = false)
    private List<PsiStepTransferInOrderMaterial> inDetails;
