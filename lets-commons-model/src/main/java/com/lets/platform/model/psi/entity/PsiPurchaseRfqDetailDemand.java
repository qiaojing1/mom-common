...
@Getter
@Setter
@TableName("psi_purchase_rfq_detail_demand")
@ApiModel(value = "PsiPurchaseRfqDetailDemand对象", description = "采购询价单单-物料明细-订单需求")
public class PsiPurchaseRfqDetailDemand extends BaseEntity {

    @ApiModelProperty("采购询价单主键")
    @TableField("order_id")
    private String orderId;

    @ApiModelProperty("采购询价单明细主键")
