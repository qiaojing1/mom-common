...
@Getter
@Setter
@TableName("psi_purchase_delivery_order_detail_serial")
@ApiModel(value = "PsiPurchaseDeliveryOrderDetailSerial对象", description = "采购收货单明细关联序列号")
public class PsiPurchaseDeliveryOrderDetailSerial extends BaseSerialEntity {

    @ApiModelProperty("采购收货单明细表id")
    @TableField("parent_id")
    private String parentId;

    @ApiModelProperty("采购订单明细表关联序列号id")
