...
@Getter
@Setter
@TableName("psi_stock_transfer_order_detail")
@ApiModel(value = "PsiStockTransferOrderDetail对象", description = "转储单物料明细")
public class PsiStockTransferOrderDetail extends BaseEntity {
