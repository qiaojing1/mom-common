...
@Getter
@Setter
@TableName("mes_produce_material_bill_order")
@ApiModel(value = "MesProduceMaterialBillOrder对象", description = "生产用料清单")
public class MesProduceMaterialBillOrder extends BaseEntity {
    ...
    @TableField(exist = false)
    private List<MesProduceMaterialBillOrderDetail> details;
    ...
    @TableField("change_serial_number")
    private Integer changeSerialNumber;
    /**
     * @see com.lets.platform.model.mes.enums.produceOrder.ChangeStatusEnum
     */
    @ApiModelProperty("变更状态[1正常、2变更中、3已变更]")
