...
@Getter
@Setter
@TableName("psi_purchase_stock_in_order")
@ApiModel(value = "PsiPurchaseStockInOrder对象", description = "采购入库单")
public class PsiPurchaseStockInOrder extends BaseEntity {
    ...
    @NotBlank(message = "Order.supplySupplierId", groups = {Save.class, Update.class})
    ...
    @TableField(exist = false)
    private int paymentConditionPriority;
    @TableField(exist = false)
    ...
    @TableField(exist = false)
    private List<PsiPurchaseStockInOrderDetail> details;
    ...
    @JsonFormat(shape = JsonFormat.Shape.STRING)
    @ApiModelProperty("可退货数量(实入库数量-占用数量-已退货数量)")
    @TableField(exist = false)
    ...
    @JsonFormat(shape = JsonFormat.Shape.STRING)
    @ApiModelProperty("可开票数量(实入库数量 - 已退货数量 - 已开票数量 - 开票占用数量)")
    @TableField(exist = false)
    private BigDecimal canInvoiceNumber;
    @JsonFormat(shape = JsonFormat.Shape.STRING)
    @ApiModelProperty("可下发数量(基本单位)")
    @TableField(exist = false)
    private BigDecimal canInvoiceBasicNumber;
    @JsonFormat(shape = JsonFormat.Shape.STRING)
    @ApiModelProperty("开票未税金额")
    @TableField(exist = false)
    private BigDecimal invoiceNotTaxAmount;
    @JsonFormat(shape = JsonFormat.Shape.STRING)
    @ApiModelProperty("开票已税金额")
    @TableField(exist = false)
    ...
    @TableField(exist = false)
    private List<PsiPurchaseOrderDetailSpecific> specificList;
