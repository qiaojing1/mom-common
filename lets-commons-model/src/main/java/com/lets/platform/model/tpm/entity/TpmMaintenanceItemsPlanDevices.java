...
@Getter
@Setter
@TableName("tpm_maintenance_items_plan_devices")
@ApiModel(value = "TpmMaintenanceItemsPlanDevices对象", description = "保养计划-设备明细")
public class TpmMaintenanceItemsPlanDevices extends BaseEntity {
    ...
    private List<TpmMaintenanceItemsPlanItems> itemsList;
}
