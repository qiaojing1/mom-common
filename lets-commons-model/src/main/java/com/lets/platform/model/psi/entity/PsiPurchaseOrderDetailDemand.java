...
@Getter
@Setter
@TableName("psi_purchase_order_detail_demand")
@ApiModel(value = "PsiPurchaseOrderDetailDemand对象", description = "采购订单-物料明细-订单需求")
public class PsiPurchaseOrderDetailDemand extends BaseEntity {

    @ApiModelProperty("采购订单主键")
    @TableField("order_id")
    ...
    @TableField(exist = false)
    private List<PsiPurchaseOrderDetailSpecific> characteristics;
    @TableField(exist = false)
