...
@Getter
@Setter
@TableName("psi_kitting_analysis_result")
@ApiModel(value = "PsiKittingAnalysisResult对象", description = "齐套分析清单")
public class PsiKittingAnalysisResult extends BaseEntity {
    ...
    @TableField(exist = false)
    private List<PsiKittingAnalysisResultDetail> detailList;
