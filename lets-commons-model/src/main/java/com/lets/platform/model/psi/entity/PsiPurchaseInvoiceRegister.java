...
@Getter
@Setter
@TableName("psi_purchase_invoice_register")
@ApiModel(value = "PsiPurchaseInvoiceRegister对象", description = "销售发票登记")
public class PsiPurchaseInvoiceRegister extends BaseEntity {
    ...
    @TableField(exist = false)
    private List<PsiPurchaseInvoiceRegisterMaterial> purchaseInvoiceRegisterMaterialList;
}
