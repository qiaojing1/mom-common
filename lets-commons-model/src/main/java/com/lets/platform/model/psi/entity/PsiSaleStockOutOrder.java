...
@Getter
@Setter
@TableName("psi_sale_stock_out_order")
@ApiModel(value = "PsiSaleStockOutOrder对象", description = "销售出库单")
public class PsiSaleStockOutOrder extends BaseEntity {
    ...
    @TableField(exist = false)
    private List<PsiSaleStockOutOrderMaterial> saleStockOutOrderMaterialList;


    @ApiModelProperty("物流信息")
    @TableField(exist = false)
    private List<PsiSaleStockOutOrderLogistics> logisticsList;

    @ApiModelProperty("物流信息标识")
    @TableField("logistics_flag")
