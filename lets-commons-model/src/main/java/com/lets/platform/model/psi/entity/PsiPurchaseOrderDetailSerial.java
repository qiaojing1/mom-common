...
@Getter
@Setter
@TableName("psi_purchase_order_detail_serial")
@ApiModel(value = "PsiPurchaseOrderDetailSerial对象", description = "采购订单明细关联序列号")
public class PsiPurchaseOrderDetailSerial extends BaseSerialEntity {

    @ApiModelProperty("采购订单明细表id")
