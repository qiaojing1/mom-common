...
@Getter
@Setter
@TableName("psi_sale_invoice_register_material")
@ApiModel(value = "PsiSaleInvoiceRegisterMaterial对象", description = "销售发票登记物料明细")
public class PsiSaleInvoiceRegisterMaterial extends BaseEntity {
