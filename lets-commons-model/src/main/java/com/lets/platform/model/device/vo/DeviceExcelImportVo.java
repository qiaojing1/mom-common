 ...
 **/
@Data
public class DeviceExcelImportVo {

    @ExcelIgnore
    private Integer order;

    @ColumnWidth(15)
    @ExcelProperty(value  = "设备名称", index = 0, order = 0)
    @ExcelName(names = {"设备名称","Device Name","デバイス名"})
    private String deviceName;

    @ColumnWidth(15)
    @ExcelProperty(value = "设备编码", index = 1, order = 1)
    @ExcelName(names = {"设备编码","Equipment coding","デバイスコーディング"})
    private String code;

    @ColumnWidth(15)
    @ExcelProperty(value = "资产编码", index = 2, order = 2)
    @ExcelName(names = {"资产编码","Asset Code","資産コード"})
    private String assetsCode;

    @ColumnWidth(15)
    @ExcelProperty(value = "使用部门", index = 3, order = 3)
    ...
    @ColumnWidth(15)
    @ExcelProperty(value = "维保部门", index = 4, order = 4)
    ...
    @ColumnWidth(15)
    @ExcelProperty(value = "保养等级", index = 5, order = 5)
    @ExcelName(names = {"保养等级","Maintenance level","保守レベル"})
    private String maintainGrade;

    @ColumnWidth(15)
    @ExcelProperty(value = "物联状态", index = 6, order = 6)
    ...
    @ColumnWidth(15)
    @ExcelProperty(value = "生产单元编码", index = 15, order = 15)
    ...
    @ColumnWidth(15)
    @ExcelProperty(value = "安装位置", index = 16, order = 16)
    @ExcelName(names = {"安装位置","Installation position","インストール場所"})
    private String installAddress;

    @ColumnWidth(15)
    @ExcelProperty(value = "设备型号", index = 17, order = 17)
    ...
    @ColumnWidth(15)
    @ExcelProperty(value = "设备类型", index = 18, order = 18)
    ...
    @ColumnWidth(15)
    @ExcelProperty(value = "控制器", index = 19, order = 19)
    ...
    @ColumnWidth(15)
    @ExcelProperty(value = "生产厂商", index = 20, order = 20)
    ...
    @ColumnWidth(15)
    @ExcelProperty(value = "供应商", index = 21, order = 21)
    ...
    @ColumnWidth(15)
    @ExcelProperty(value = "购置日期", index = 22, order = 22)
    ...
    @ColumnWidth(15)
    @ExcelProperty(value = "购置金额", index = 23, order = 23)
    @ExcelName(names = {"购置金额","Purchase amount","購入金額"})
    private String purchaseAmount;

    @ColumnWidth(15)
    @ExcelProperty(value = "入厂日期", index = 24, order = 24)
    ...
    @ColumnWidth(15)
    @ExcelProperty(value = "质保日期", index = 25, order = 25)
    ...
    @ColumnWidth(15)
    @ExcelProperty(value = "备注", index = 26, order = 26)
