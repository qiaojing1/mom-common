...
@Getter
@Setter
@TableName("tpm_inspection_project_route_plan_items")
@ApiModel(value = "TpmInspectionProjectRoutePlanItems对象", description = "巡检计划-巡检项目")
public class TpmInspectionProjectRoutePlanItems extends BaseEntity {

    @ApiModelProperty("计划id")
    @TableField("plan_id")
    private String planId;

    @ApiModelProperty("巡检计划-巡检路线id")
