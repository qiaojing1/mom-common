...
@Getter
@Setter
@TableName("psi_cooperate_deliver_order_detail_specific")
@ApiModel(value = "PsiCooperateDeliverOrderDetailSpecific对象", description = "协同送货单-明细-特征属性")
public class PsiCooperateDeliverOrderDetailSpecific extends BaseEntity {
