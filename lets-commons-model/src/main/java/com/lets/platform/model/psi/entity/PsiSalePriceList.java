...
@Getter
@Setter
@TableName("psi_sale_price_list")
@ApiModel(value = "PsiSalePriceList对象", description = "采购价目表")
public class PsiSalePriceList extends BaseEntity {
    ...
    @ExcelIgnore
    @TableField("sale_price_setting_id")
    private String salePriceSettingId;
    ...
    @ExcelIgnore
    @TableField(exist = false)
    private List<PsiSalePriceListCustomer> customers;
    @ExcelIgnore
    @Valid
    @TableField(exist = false)
    private List<PsiSalePriceListDetails> details;
}
