...
@Getter
@Setter
@TableName("psi_kitting_analysis_result_detail_sub_record")
@ApiModel(value = "PsiKittingAnalysisResultDetailSubRecord对象", description = "齐套分析清单明细子项供应明细")
public class PsiKittingAnalysisResultDetailSubRecord extends BaseEntity {
