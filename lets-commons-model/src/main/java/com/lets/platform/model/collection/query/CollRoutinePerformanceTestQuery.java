...
/**
 * @author zhangweiyan
 * @ClassName CollRoutinePerformanceTestQuery
 * @Description 常规性能试验查询Query
 * @Date 2024/1/27 13:41
 **/
@Data
@ApiModel("常规性能试验查询Query")
@Component
public class CollRoutinePerformanceTestQuery {
    ...
    @ApiModelProperty(required = false, value = "压力单位的id")
    private String pressureUnitId;

    @ApiModelProperty(required = false, value = "密封方式")
    private String sealMethod;
    @ApiModelProperty(required = false,value = "密封方式Id")
    private String sealMethodId;
    @ApiModelProperty(hidden = true)
    // 枚举密封方式
    ...
    @ApiModelProperty(hidden = true)
    private Set<String> escapeProjectIds;
    @ApiModelProperty(hidden = true)
    private Set<String> valveClassifyIds;
    @ApiModelProperty(hidden = true)
    private Set<String> mediaTypes;

    @ApiModelProperty("试验类型 1:常规性能试验 2:低温密封试验 3:洁净性能试验 6:压力试验")
    ...
    public String toString() {
        return "CollRoutinePerformanceTestQuery{" +
                ...
                ", torque=" + torque +
                ", loadedTorque=" + loadedTorque +
                ", unloadedTorque=" + unloadedTorque +
                '}';
    }
}
