...
@Getter
@Setter
@TableName("psi_wip_completion_stock_in_order_serial")
@ApiModel(value = "PsiWipCompletionStockInOrderSerial对象", description = "完工入库单关联序列号")
public class PsiWipCompletionStockInOrderSerial extends BaseSerialEntity {

    @ApiModelProperty("完工入库单id")
    @TableField("order_id")
    private String orderId;

    @ApiModelProperty("完工入库单明细id")
