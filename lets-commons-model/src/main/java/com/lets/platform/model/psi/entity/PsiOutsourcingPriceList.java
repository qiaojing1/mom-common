...
@Getter
@Setter
@TableName("psi_outsourcing_price_list")
@ApiModel(value = "PsiOutsourcingPriceList对象", description = "工序委外价目表")
public class PsiOutsourcingPriceList extends BaseEntity {
    ...
    @ExcelIgnore
    @TableField(exist = false)
    private List<PsiOutsourcingPriceListSupplier> suppliers;
    @ExcelIgnore
    @Valid
    @TableField(exist = false)
    private List<PsiOutsourcingPriceListDetails> details;
}
