...
@Getter
@Setter
@TableName("psi_purchase_apply_order_detail_demand")
@ApiModel(value = "PsiPurchaseApplyOrderDetailDemand对象", description = "采购申请单-物料明细-订单需求")
public class PsiPurchaseApplyOrderDetailDemand extends BaseEntity {

    @ApiModelProperty("采购申请单主键")
    @TableField("order_id")
    private String orderId;
    @ApiModelProperty("采购申请单明细主键")
