...
@Getter
@Setter
@TableName("psi_sale_return_application_serial")
@ApiModel(value = "PsiSaleReturnApplicationSerial对象", description = "销售退货申请关联序列号")
public class PsiSaleReturnApplicationSerial extends BaseSerialEntity {

    @ApiModelProperty("销售退货申请单id")
    @TableField("order_id")
    private String orderId;

    @ApiModelProperty("销售退货申请单明细id")
