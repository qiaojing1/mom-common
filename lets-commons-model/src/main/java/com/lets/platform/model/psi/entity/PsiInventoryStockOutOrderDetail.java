...
@Getter
@Setter
@TableName("psi_inventory_stock_out_order_detail")
@ApiModel(value = "PsiInventoryStockOutOrderDetail对象", description = "盘亏出库单-明细")
public class PsiInventoryStockOutOrderDetail extends BaseEntity {
